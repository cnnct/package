...
比如：&lt;tx:method name="query\*" propagation="NOT\_SUPPORTED" /&gt;

其中，name的值就是要过滤的方法名前缀再加上\*即可，propagation="NOT\_SUPPORTED"表示不使用事务的意思，propagation="REQUIRED"则表示使用事务。![](/assets/Main1.png)
